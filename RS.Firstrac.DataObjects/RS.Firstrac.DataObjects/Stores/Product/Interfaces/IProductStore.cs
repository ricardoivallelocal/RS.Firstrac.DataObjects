...
namespace RS.Firstrac.DataObjects.Stores.Product.Interfaces
{
    ...
    public interface IProductStore : IStoreBase<IProduct>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IProduct>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true);
