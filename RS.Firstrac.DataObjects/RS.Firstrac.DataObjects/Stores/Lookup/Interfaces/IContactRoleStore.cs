...
namespace RS.Firstrac.DataObjects.Stores.Lookup.Interfaces
{
	public interface IContactRoleStore : IStoreBase<IContactRole>
	{
		...
		Task<IAPIOperationResult<IEnumerable<IContactRole>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true);
