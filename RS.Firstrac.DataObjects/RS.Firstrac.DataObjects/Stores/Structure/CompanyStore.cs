...
namespace RS.Firstrac.DataObjects.Stores.Structure
{
    ...
    public class CompanyStore : StoreBase, ICompanyStore
	{
		...
		{
			return await _firstracApiHelper.GetAsync<APIOperationResult<IEnumerable<ICompany>>>("api/company", null);
		}
		...
		{
			return await _firstracApiHelper.GetAsync<APIOperationResult<ICompany>>("api/company/{id}", id);
		}
