...
namespace RS.Firstrac.DataObjects.Stores.Admin.Interfaces
{
    ...
    public interface IProductServiceStore : IStoreBase<IProductService>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IProductService>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true);
        /// <summary>
