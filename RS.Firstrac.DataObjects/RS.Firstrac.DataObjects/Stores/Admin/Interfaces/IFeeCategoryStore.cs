...
namespace RS.Firstrac.DataObjects.Stores.Admin.Interfaces
{
    ...
    public interface IFeeCategoryStore : IStoreBase<IFeeCategory>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IFeeCategory>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true);
        /// <summary>
