...
namespace RS.Firstrac.DataObjects.Stores.Interfaces
{
      ...
      where TInterface : IValidate
    {
        ...
        Task<IAPIOperationResult<IEnumerable<TInterface>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string, object>? dependencies = null);
        /// <summary>
