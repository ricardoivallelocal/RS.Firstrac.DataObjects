...
namespace RS.Firstrac.DataObjects.Stores.Structure.Interfaces
{
    public interface IContactAddressStore : IStoreBase<IContactAddress>
	{
		...
		Task<IAPIOperationResult<IEnumerable<IContactAddress>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string,object>? dependencies = null);
		...
		/// <returns>Task&lt;IAPIOperationResult&lt;System.Boolean&gt;&gt;.</returns>
		Task<IAPIOperationResult<bool>> Save(IContactAddress model);
	}
}
