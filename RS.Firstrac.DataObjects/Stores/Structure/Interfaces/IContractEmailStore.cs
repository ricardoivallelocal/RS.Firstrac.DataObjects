...
namespace RS.Firstrac.DataObjects.Stores.Structure.Interfaces
{
    public interface IContractEmailStore : IStoreBase<IContactEmail>
	{
		...
		Task<IAPIOperationResult<IEnumerable<IContactEmail>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string,object>? dependencies = null);
