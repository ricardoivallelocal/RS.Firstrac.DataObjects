...
namespace RS.Firstrac.DataObjects.Stores.Structure
{
    public class ProductFeeStore : IProductFeeStore
    {
        ...
        public async Task<IAPIOperationResult<IEnumerable<IDropdownItem>>> GetForDropdown(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true)
        {
