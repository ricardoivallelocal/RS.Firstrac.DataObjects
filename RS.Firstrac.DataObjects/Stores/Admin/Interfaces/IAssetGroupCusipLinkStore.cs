...
namespace RS.Firstrac.DataObjects.Stores.Admin.Interfaces
{
    ...
    public interface IAssetGroupCusipLinkStore : IStoreBase<IAssetGroupCusipLink>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IAssetGroupCusipLink>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string, object>? dependencies = null);
        /// <summary>
