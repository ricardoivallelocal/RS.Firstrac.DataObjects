...
namespace RS.Firstrac.DataObjects.Stores.Admin.Interfaces
{
    ...
    public interface ILegalEntityTitleStore : IStoreBase<ILegalEntityTitle>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<ILegalEntityTitle>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string, object>? dependencies = null);
        /// <summary>
