...
namespace RS.Firstrac.DataObjects.Stores.Lookup.Interfaces
{
    ...
    public interface IInvoiceDeliveryOptionStore : IStoreBase<IInvoiceDeliveryOption>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IInvoiceDeliveryOption>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true);
        /// <summary>
