...
namespace RS.Firstrac.DataObjects.Stores.Lookup.Interfaces
{
    ...
    public interface IExternalApplicationStore : IStoreBase<IExternalApplication>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IExternalApplication>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string,object>? dependencies = null);
        /// <summary>
