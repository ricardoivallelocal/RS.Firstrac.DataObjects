...
namespace RS.Firstrac.DataObjects.Stores.Lookup.Interfaces
{
    public interface IFeeDeductionMethodStore : IStoreBase<IFeeDeductionMethod>
    {
        ...
        Task<IAPIOperationResult<IEnumerable<IFeeDeductionMethod>>> GetAll(bool? activeOnly, Dictionary<string, object>? filterBy = null, bool? exactMatch = true, bool? mutuallyExclusive = false, bool? includeNavigationProperties = true, Dictionary<string,object>? dependencies = null);
