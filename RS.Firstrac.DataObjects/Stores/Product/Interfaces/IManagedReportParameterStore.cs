...
namespace RS.Firstrac.DataObjects.Stores.Product.Interfaces
{
    ...
    public interface IManagedReportParameterStore : IStoreBase<IManagedReportParameter>
    {
        #region Methods
        ...
        Task<IAPIOperationResult<IManagedReportParameter>> Get(int id);
        ...
        /// <returns>Task&lt;IAPIOperationResult&lt;System.Boolean&gt;&gt;.</returns>
        Task<IAPIOperationResult<bool>> Save(IManagedReportParameter model);
