...
namespace RS.Firstrac.DataObjects.Stores.Invoice.Interfaces
{
	...
	public interface IInvoiceGenerationStore
	{
		...
		/// <returns></returns>
		Task<IAPIOperationResult<IEnumerable<IInvoiceHistoryItemOfAccount>>> GetInvoiceHistoryByAccountNumber(string accountNumber, bool? includeVoid = true);
        /// <summary>
        /// Get batch invoice history, optionally filtering by account number.
        /// </summary>
        /// <returns></returns>
        Task<IAPIOperationResult<IEnumerable<IBatchInvoiceHistoryItem>>> GetInvoiceHistoryBatch(string? accountNumber = null);
